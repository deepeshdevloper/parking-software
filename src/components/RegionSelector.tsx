...
const RegionSelector: React.FC<RegionSelectorProps> = ({ imageUrl, onRegionsChange }) => {
  ...
  useEffect(() => {
    // Convert regions to normalized coordinates (0-1) before passing to parent
    // This ensures regions work across different video/image resolutions
    if (originalSize.width > 0 && originalSize.height > 0) {
      ...
      onRegionsChange(normalizedRegions);
    }
    redrawCanvas();
